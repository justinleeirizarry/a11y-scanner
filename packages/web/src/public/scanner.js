...
function buildComplianceData(r) {
    ...
    if (r.wcag22) {
        const wcag22Map = {
            ...
            mediaAudioDescription: '1.2.3',
            mediaLiveCaptions: '1.2.4',
            mediaSignLanguage: '1.2.6',
            mediaExtendedAudioDescription: '1.2.7',
            mediaAlternative: '1.2.8',
            mediaLiveAudio: '1.2.9',
            mediaBackgroundAudio: '1.4.7',
            imagesOfText: '1.4.9',
            keyboardNoException: '2.1.3',
            noTiming: '2.2.3',
            interruptions: '2.2.4',
            reAuthenticating: '2.2.5',
            timeouts: '2.2.6',
            threeFlashesAbsolute: '2.3.2',
            location: '2.4.8',
            focusNotObscuredEnhanced: '2.4.12',
            targetSizeEnhanced: '2.5.5',
            concurrentInput: '2.5.6',
            unusualWords: '3.1.3',
            abbreviations: '3.1.4',
            readingLevel: '3.1.5',
            pronunciation: '3.1.6',
            ...
            help: '3.3.5',
            errorPreventionAll: '3.3.6',
            accessibleAuthEnhanced: '3.3.9',
        };
