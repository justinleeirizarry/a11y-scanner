...
export const WCAG22ViolationId = Schema.Literal(
    ...
    'media-live-captions',
    'media-sign-language',
    'media-extended-audio-description',
    'media-alternative',
    'media-live-audio',
...
export const WCAG22Results = Schema.Struct({
    ...
    sensoryCharacteristics: Schema.Array(WCAG22ViolationSummary),
    identifyPurpose: Schema.Array(WCAG22ViolationSummary),
    visualPresentation: Schema.Array(WCAG22ViolationSummary),
    characterKeyShortcuts: Schema.Array(WCAG22ViolationSummary),
    animationInteractions: Schema.Array(WCAG22ViolationSummary),
    threeFlashes: Schema.Array(WCAG22ViolationSummary),
    sectionHeadings: Schema.Array(WCAG22ViolationSummary),
    pointerGestures: Schema.Array(WCAG22ViolationSummary),
    pointerCancellation: Schema.Array(WCAG22ViolationSummary),
    motionActuation: Schema.Array(WCAG22ViolationSummary),
    onFocus: Schema.Array(WCAG22ViolationSummary),
    onInput: Schema.Array(WCAG22ViolationSummary),
    redundantEntry: Schema.Array(WCAG22ViolationSummary),
    mediaAudioDescription: Schema.Array(WCAG22ViolationSummary),
    mediaLiveCaptions: Schema.Array(WCAG22ViolationSummary),
    mediaSignLanguage: Schema.Array(WCAG22ViolationSummary),
    mediaExtendedAudioDescription: Schema.Array(WCAG22ViolationSummary),
    mediaAlternative: Schema.Array(WCAG22ViolationSummary),
    mediaLiveAudio: Schema.Array(WCAG22ViolationSummary),
    mediaBackgroundAudio: Schema.Array(WCAG22ViolationSummary),
    imagesOfText: Schema.Array(WCAG22ViolationSummary),
    keyboardNoException: Schema.Array(WCAG22ViolationSummary),
    noTiming: Schema.Array(WCAG22ViolationSummary),
    interruptions: Schema.Array(WCAG22ViolationSummary),
    reAuthenticating: Schema.Array(WCAG22ViolationSummary),
    timeouts: Schema.Array(WCAG22ViolationSummary),
    threeFlashesAbsolute: Schema.Array(WCAG22ViolationSummary),
    location: Schema.Array(WCAG22ViolationSummary),
    focusNotObscuredEnhanced: Schema.Array(WCAG22ViolationSummary),
    targetSizeEnhanced: Schema.Array(WCAG22ViolationSummary),
    concurrentInput: Schema.Array(WCAG22ViolationSummary),
    unusualWords: Schema.Array(WCAG22ViolationSummary),
    abbreviations: Schema.Array(WCAG22ViolationSummary),
    readingLevel: Schema.Array(WCAG22ViolationSummary),
    pronunciation: Schema.Array(WCAG22ViolationSummary),
    errorPreventionLegal: Schema.Array(WCAG22ViolationSummary),
