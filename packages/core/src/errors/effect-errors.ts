...
// ============================================================================
// Non-prefixed aliases for cleaner usage (preferred)
// ============================================================================

/** @see EffectReactNotDetectedError */
export const ReactNotDetected = EffectReactNotDetectedError;
export type ReactNotDetected = EffectReactNotDetectedError;

/** @see EffectBrowserLaunchError */
export const BrowserLaunchFailed = EffectBrowserLaunchError;
export type BrowserLaunchFailed = EffectBrowserLaunchError;

/** @see EffectBrowserNotLaunchedError */
export const BrowserNotLaunched = EffectBrowserNotLaunchedError;
export type BrowserNotLaunched = EffectBrowserNotLaunchedError;

/** @see EffectBrowserAlreadyLaunchedError */
export const BrowserAlreadyLaunched = EffectBrowserAlreadyLaunchedError;
export type BrowserAlreadyLaunched = EffectBrowserAlreadyLaunchedError;

/** @see EffectNavigationTimeoutError */
export const NavigationTimeout = EffectNavigationTimeoutError;
export type NavigationTimeout = EffectNavigationTimeoutError;

/** @see EffectNavigationError */
export const NavigationFailed = EffectNavigationError;
export type NavigationFailed = EffectNavigationError;

/** @see EffectContextDestroyedError */
export const ContextDestroyed = EffectContextDestroyedError;
export type ContextDestroyed = EffectContextDestroyedError;

/** @see EffectScannerInjectionError */
export const ScannerInjectionFailed = EffectScannerInjectionError;
export type ScannerInjectionFailed = EffectScannerInjectionError;

/** @see EffectMaxRetriesExceededError */
export const MaxRetriesExceeded = EffectMaxRetriesExceededError;
export type MaxRetriesExceeded = EffectMaxRetriesExceededError;

/** @see EffectConfigurationError */
export const InvalidConfiguration = EffectConfigurationError;
export type InvalidConfiguration = EffectConfigurationError;

/** @see EffectInvalidUrlError */
export const InvalidUrl = EffectInvalidUrlError;
export type InvalidUrl = EffectInvalidUrlError;

/** @see EffectFileSystemError */
export const FileSystemFailed = EffectFileSystemError;
export type FileSystemFailed = EffectFileSystemError;

/** @see EffectServiceStateError */
export const InvalidServiceState = EffectServiceStateError;
export type InvalidServiceState = EffectServiceStateError;

/** @see EffectScanDataError */
export const InvalidScanData = EffectScanDataError;
export type InvalidScanData = EffectScanDataError;

/** @see EffectTestGenNotInitializedError */
export const TestGenNotInitialized = EffectTestGenNotInitializedError;
export type TestGenNotInitialized = EffectTestGenNotInitializedError;

/** @see EffectTestGenInitError */
export const TestGenInitFailed = EffectTestGenInitError;
export type TestGenInitFailed = EffectTestGenInitError;

/** @see EffectTestGenNavigationError */
export const TestGenNavigationFailed = EffectTestGenNavigationError;
export type TestGenNavigationFailed = EffectTestGenNavigationError;

/** @see EffectTestGenDiscoveryError */
export const TestGenDiscoveryFailed = EffectTestGenDiscoveryError;
export type TestGenDiscoveryFailed = EffectTestGenDiscoveryError;
