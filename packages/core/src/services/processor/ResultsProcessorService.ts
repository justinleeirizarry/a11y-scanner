        ...
        return Effect.sync(() => {
            ...
            if (results.wcag22 && wcag22Total > 0) {
                ...
                const checkCategories: Array<{ key: string; label: string }> = [
                    ...
                    { key: 'imagesOfTextAA', label: 'Images of Text (1.4.5)' },
                    { key: 'imagesOfText', label: 'Images of Text — No Exception (1.4.9)' },
                    { key: 'nonTextContrast', label: 'Non-text Contrast (1.4.11)' },
